...
require (
	buf.build/gen/go/hasir/hasir/connectrpc/go v1.19.1-20251210080230-abe285f01966.2
	buf.build/gen/go/hasir/hasir/protocolbuffers/go v1.36.10-20251210080230-abe285f01966.1
