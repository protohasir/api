...
require (
	buf.build/gen/go/hasir/hasir/connectrpc/go v1.19.1-20251211095003-cc6a5c19d465.2
	buf.build/gen/go/hasir/hasir/protocolbuffers/go v1.36.10-20251211095003-cc6a5c19d465.1
