...
// Source: internal/organization/service.go
...
func (mr *MockServiceMockRecorder) CreateOrganization(ctx, req, createdBy interface{}) *gomock.Call {
...
func (mr *MockServiceMockRecorder) RespondToInvitation(ctx, token, userId, accept interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
